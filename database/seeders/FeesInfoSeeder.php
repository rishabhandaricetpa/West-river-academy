...
class FeesInfoSeeder extends Seeder
{
    ...
    public function run()
    {
        $data = [
            ...
            ['type' => 'transcript', 'description' => 'Initial Transcript', 'amount' => '80'],
            ['type' => 'transcript_edit', 'description' => 'Edit Transcript Fee', 'amount' => '25'],
            ['type' => 'express_international', 'description' => 'Express International Tier 1', 'amount' => '85'],
            ['type' => 'global_guaranteed_international', 'description' => 'Express International Tier 2', 'amount' => '105'],
            ['type' => 'united_postal_service', 'description' => 'Express International Tier 3', 'amount' => '85'],
            ['type' => 'priority_international', 'description' => 'Priority International', 'amount' => '120'],

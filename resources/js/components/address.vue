  ...
  <form method="POST" @submit.prevent="addPayments()">
    <div class="form-wrap border bg-light py-5 px-25">
      ...
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="first_name" v-model="form.billing_address.first_name" required
      ...
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="last_name" v-model="form.billing_address.last_name" required
            aria-describedby="emailHelp" />
        </div>
      </div>
      ...
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="street" v-model="form.billing_address.street_address" required
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="city" v-model="form.billing_address.city" required
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="state" v-model="form.billing_address.state" required
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="text" class="form-control" name="zip_code" v-model="form.billing_address.zip_code" required
            aria-describedby="emailHelp" />
        </div>
      </div>
    ...
    <div class="form-wrap border bg-light py-5 px-25 mt-2r">
      ...
      <div class="checkbox">
        <label for="sSame" class="sSame"><input type="checkbox" @change="copyBilling" id="sSame" v-model="form.sSame" />
          Same as Billing Address</label>
      </div>
      <div class="form-group d-sm-flex mb-2">
        <label for="">First Name</label>
        <div>
          <input type="text" class="form-control" name="first_name" v-model="form.shipping_address.first_name"
            aria-describedby="emailHelp" />
        </div>
      </div>
      ...
      <div class="form-group d-sm-flex mb-2">
        <label for="">Last Name</label>
        <div>
          <input type="text" class="form-control" name="last_name" v-model="form.shipping_address.last_name"
            aria-describedby="emailHelp" />
        </div>
      </div>
      ...
      <div class="form-group d-sm-flex mb-2">
        <label for="">Street</label>
        <div>
          <input type="text" class="form-control" name="street" v-model="form.shipping_address.street_address"
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        <label for="">City</label>
        <div>
          <input type="text" class="form-control" name="city" v-model="form.shipping_address.city"
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        <label for="">State</label>
        <div>
          <input type="text" class="form-control" name="state" v-model="form.shipping_address.state"
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex mb-2">
        <label for="">Zip Code</label>
        <div>
          <input type="text" class="form-control" name="zip_code" v-model="form.shipping_address.zip_code"
            aria-describedby="emailHelp" />
        </div>
      </div>
      <div class="form-group d-sm-flex">
    ...
    <div class="form-wrap border bg-light py-5 px-25 mt-2r">
      ...
      <div class="form-group d-sm-flex mb-2">
        ...
        <div>
          <input type="email" class="form-control" name="email" v-model="form.email" aria-describedby="emailHelp" />
        </div>
      </div>
    </div>
    <div class="form-wrap border bg-light py-5 px-25 mt-2r">
      ...
      <div class="form-group d-sm-flex mb-2 col-md-6 px-0">
        ...
        <div>
          <input type="text" class="form-control" v-model="couponSelected" placeholder="Enter coupon code" />
        </div>
      </div>
    ...
    <div class="form-wrap border bg-light py-5 px-25 mt-2r">
      ...
      <p class="font-md">All transactions are final and fees are non-refundable without prior written agreement. Click
        <a href="#" type="button" data-toggle="modal" data-target=".bd-example-modal-lg"><strong>here</strong></a> for
        full Refund Policy (https::www.westriveracademy.com/refund-policy)</p>
    </div>
            ...
            <div class="refund-page">
              <div>
                <div class="container">
                  <div class="row">
                    <div class="col-12">
                      <p>WEST RIVER ACADEMY (the “Company”) has a <strong>NO REFUND</strong> policy for its services,
                        products and
                        enrollment.</p>
                      <p>Please note that all transactions are <strong>final</strong> and fees are
                        <strong>non-refundable</strong>
                        unless prior agreement has been made with West River Academy.</p>
                      <p>If you have any questions or concerns, please contact West River Academy at
                        <a href="mailto:Contact@westriveracademy.com">Contact@westriveracademy.com</a>
                        <strong>PRIOR</strong> to making any payments.</p>
                      <p><strong>Your Acceptance of These Terms:</strong> By enrolling in West River Academy, you accept
                        the
                        policies
                        ...
                        current Refund
                        Policy
                        to which you are bound.</p>
                      <p><em><strong>En Español:</strong></em></p>
                      <p>WEST RIVER ACADEMY (la “Compañía”) tiene una política de NO REEMBOLSO para sus servicios,
                        productos e
                        inscripción.</p>
                      <p>Tenga en cuenta que todas las transacciones son finales y los honorarios no son reembolsables
                        acuerdo a
                        menos
                        que antes se ha hecho con West River Academy.</p>
                      <p>Si tiene alguna pregunta o inquietud, comuníquese con West River Academy en
                        <a href="mailto:Contact@westriveracademy.com">Contact@westriveracademy.com</a>
                        ANTES de realizar cualquier pago.
                      </p>
                      <p><strong>Su aceptación de estos términos:</strong> Al inscribirse en West River Academy, acepta
                        las
                        políticas y
                        ...
                        revisar la
                        Política de reembolso vigente en ese momento a la que está obligado.</p>
      ...
      <ul class="list-unstyled enlarge-input payment-method">
        <li class="py-3 pl-3">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="payment_type" value="Credit Card"
              v-model="form.paymentMethod.payment_type" required />
          </div>
        ...
        <li class="py-3 pl-3">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="payment_type" value="Bank Transfer"
              v-model="form.paymentMethod.payment_type" />
          </div>
          <div class="payment-info">
            <h3>Bank Transfer</h3>
        ...
        <li class="py-3 pl-3">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="payment_type" value="MoneyGram"
              v-model="form.paymentMethod.payment_type" />
          </div>
          <div class="payment-info">
            <h3>MoneyGram</h3>
        ...
        <li class="py-3 pl-3">
          <div class="form-check">
            <input class="form-check-input" type="radio" name="payment_type" value="Check or Money Order"
              v-model="form.paymentMethod.payment_type" />
          </div>
          <div class="payment-info">

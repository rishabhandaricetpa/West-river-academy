        ...
        if($leftCount < $rightCount) { for($i=1 ; $i <=($rightCount - $leftCount); $i++){ // push dummy course having -1
          ...
          if($rightCount < $leftCount) { for($i=1 ; $i <=($leftCount - $rightCount); $i++) { $rightGroup->last()->push((object)['id'=> -1]);
            ...
            <table style="margin-bottom:20px;" width="100%">
              <tbody>
                <tr style="width:100%;">
                  <td width="50%" style="text-transform:uppercase;font-weight: 700;font-size:25px;">official transcript
                  </td>
            ...
            <table>
            <tbody>
            <tr><td valign="top" style="text-transform:uppercase;width:10%;font-size:11px;line-height:1;">Name</td>
                  <td valign="top"
                  ...
                  <tr><td valign="top" style="text-transform:uppercase;font-size:13px;width:10%;"></td>
                  <td valign="top" style="font-weight:700;text-transform:uppercase;text-align:left;font-size:13px;width:50%;"></td>
            ...
            <tr>
            <td  valign="top" style="text-transform:uppercase;font-size:11px;width:20%;line-height:1;">years(s)</td>
                  <td valign="top"
            ...
            <tr>
            <td valign="top" style="text-transform:uppercase;font-size:11px;width:20%;line-height:1;">grade level(s)</td>
                  <td valign="top"
                    style="font-weight:700;text-transform:uppercase;text-align:left;font-size:11px;width:20%;line-height:1;">
            ...
            <table width="100%" style="padding-top:30px;vertical-align:top;" class="mt-5">
              <tr>
                <td width="35%" style="vertical-align:top;padding:0 30px;padding-left:0;">
                  ...
                  <p style="font-size:13px;" class="mt-4">West River Academy is accredited by the National Association
                    for the Legal Support of Alternative Schools (NALSAS) and registered in the California School
                    Directory. CDS Code: 30 66464 6134720 County: Orange Address: 33721 Bluewater Ln. Dana Point, CA
                    92629-2173</p>
                </td>
                <td width="45%" style="vertical-align:top;padding:0 30px;">
                  ...
                  <table style="border:1px solid #000;" width="100%">
                    <thead>
                      <tr>
                        <th colspan="4" style="width:100%;text-align:center;font-weight:600;margin-bottom:0;">Grading
                          System </th>
                      </tr>
                    ...
                    <tr style="width:100%;">
                      <td style="text-align:center;width:100%;" colspan="2">
                        <div style="margin:0 auto;"><img src="{{asset('images/Stamp.png')}}"
                            style="width: 120px;height:120px;object-fit:contain;display:block;" alt="Stamp"></div>
                      </td>
                    </tr>
                  </table>

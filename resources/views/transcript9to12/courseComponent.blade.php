                ...
                @else
                    @if ($course->type === 'year')
                        <tr style="line-height:1;">
                            ...
                            @if ($course->score == 'PASS')
                                <td style="padding:3px 6px;line-height:1;font-size:13px;">
                                    P</td>
                            @else
                                <td style="padding:3px 6px;line-height:1;font-size:13px;">
                                    {{ $course->score }}</td>
                    ...
                    @elseif($course->type === 'courseInProgress')
                        <tr style="line-height:1;">
                            ...
                            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{ $course->credit }}</td>
                            @if ($course->score == 'PASS')
                                <td style="padding:3px 6px;line-height:1;font-size:13px;">P</td>
                            @else
                                <td style="padding:3px 6px;line-height:1;font-size:13px;">
                                    {{ $course->score }}</td>
                            @endif
                    ...
                    @elseif($course->type =='college')
                        <tr style="line-height:1;">
                            <td style="padding:3px 6px;line-height:1;font-size:13px;text-transform:uppercase;">
                                {{ $course->groupBy }}</td>
                            <td style="padding:3px 6px;line-height:1;font-size:13px;"> {{ $course->grade }}</td>
                            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{ $course->selectedCredit }}
                            </td>
                            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{ $course->course_grade }}
                            </td>
                        </tr>
                    @endif
                @endif

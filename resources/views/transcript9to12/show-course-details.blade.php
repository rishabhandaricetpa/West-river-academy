...
@section('content')
    ...
    <main class="position-relative container form-content mt-4">
        <h1 class="text-center text-white text-uppercase">Transcript Wizard for Grade School (Grades 9-12)</h1>
            ...
            <div class="overflow-auto">
                <table class="table-styling w-100">
                    ...
                    <tfoot>
                        <tr>
                            <td class="pl-0 pt-4">
                                <a href="{{ route('edit.englishTranscriptCourse', [$student_id, $transcript_id]) }}"
                                    class="btn btn-primary">Edit Courses
                                </a>
                            </td>
                        </tr>
                    </tfoot>

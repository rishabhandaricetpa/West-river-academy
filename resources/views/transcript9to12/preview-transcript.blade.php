    ...
    <tbody>
      <tr style="width:100%;">
        <table style="width:100%;border-collapse:collapse;" border="1">
          <tr>
            <td style="width:50%;">
              <table style="width:100%;border-collapse:collapse;">
                ...
                <tbody>
                  <tr style="line-height:1;">
                    <td style="font-weight:700;text-align:center;font-size:13px;" colspan="4"><span style="text-decoration:underline;">Academic Year{{ $grade['enrollment_year'] }} - {{ (int)$grade['enrollment_year']+1 }}</span></td>
                  </tr>
          </tr>
          ...
          <tr style="line-height:1;">
            <td style="padding:3px 6px;line-height:1;font-size:13px;text-transform:uppercase;">{{ $subject['subject']['subject_name'] }}</td>
            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{ $grade['grade'] }} </td>
            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{ $subject['credit']['credit'] }}</td>
            <td style="padding:3px 6px;line-height:1;font-size:13px;">{{$subject['score']}}</td>
          </tr>
          @endforeach
    </tbody>
  </table>

<head>
    ...
    <link href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-datepicker/1.5.0/css/bootstrap-datepicker.css"
        rel="stylesheet">
    <div class="overlay-black position-absolute main-bg h-100"><img src="/images/gradient-bg.jpg" class="h-100 o-cover"
            alt="bg-img"></div>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark px-0">
        ...
        <div class="collapse navbar-collapse" id="main-header">
            ...
            <div class="action-buttons d-none">
                ...
                <a href="{{ route('login') }}" class="user-login"><img class="o-contain" src="/images/login-img.png"
                        alt=""></a>
            </div>

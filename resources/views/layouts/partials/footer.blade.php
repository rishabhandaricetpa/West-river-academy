...
<footer class="bg-dark position-relative text-center main-footer">
    <div class="container">
        ...
        <ul class="social-icons list-unstyled d-flex justify-content-center">
            ...
            <li><a href="https://www.westriveracademy.com/blog/" target="_blank" class="mx-2"><img
                        src="/images/Blog.png" class="o-contain" alt="blog" /></a></li>
            <li><a href="https://www.instagram.com/west.river.academy/" target="_blank" class="mx-2"><img
                        src="/images/Instagram.png" class="o-contain" alt="Instagram" /></a></li>
            <li><a href="https://mewe.com/i/westriveracademy" target="_blank" class="mx-2"><img src="/images/MeWe.png"
                        class="o-contain" alt="MeWe" /></a></li>
            <li><a href="https://www.pinterest.com/west_river/" target="_blank" class="mx-2"><img
                        src="/images/Pinterest.png" class="o-contain" alt="Pinterest" /></a></li>
        </ul>
        ...
        <div class="copyright">
            ...
            <a href="https://www.ithands.com" target="_blank" class="d-block">Website design, development and
                maintenance by ITH.</a>
        </div>

<sidebar class="main-sidebar bg-secondary pt-5 fixed-top">
    <ul class="list-unstyled">
        ...
        <li><a href="{{ route('enrolled.students') }}"><span>Transcript Wizard</span><i class="fas fa-2x fa-shopping-cart"></i></a></li>
        ...
        <li><a href="{{url('social/media')}}"><span>Join our Community</span><i class="fas fa-2x fa-book-open"></i></a></li>

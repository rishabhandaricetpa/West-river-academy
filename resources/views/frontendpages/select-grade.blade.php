            ...
            <form method="POST" class="mb-0" action="{{ route('enroll') }}">
               ...
               <div class="form-group mb-2 lato-italic info-detail pb-2">
                  <div class="form-check mb-2">
                     <input class="form-check-input" type="radio" name="student_grade" value="Upgraded" required>
                  ...
                  <div class="col-sm-6 px-0">
                     ...
                     <div class="mb-2 form-check">
                        <input class="form-check-input" type="radio" name="student_grade" required>
                        <label class="form-check-label" for="">
                           West River Academy
                        </label>
                     </div>
                     <div class="form-check d-sm-flex mb-2">
                        <input class="form-check-input" type="radio" name="student_grade">
                        <label class="form-check-label" for="">

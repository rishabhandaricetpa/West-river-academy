...
<table border="1" style="border-collapse:collapse; margin: 20px 0;font-family:'Catamaran', sans-serif;" rowspan>
    <thead>
        <tr>
            ...
            <td style="padding:8px;text-align:left"> 20-march-2020</td>
        </tr>
    </thead>
    <tbody>
        <tr>
          
            <th style="padding:8px;" scope="row">PAYMENT</th>
...
<table border="1" style="border-collapse:collapse; margin: 20px 0;font-family:'Catamaran', sans-serif;">
  <thead>
      <tr>
          ...
          <th style="padding:8px;">ITEM TOTAL</th>
      </tr>
  </thead>
  <tbody>
      <tr>
      <td style="padding:8px;">CUSTPAYMENT</td>
  ...
  <tfoot>
      ...
      <td style="padding:8px;" colspan="3"> $0.00</td>
  </tfoot>
</table>
Your Address

        ...
        <div class="form-wrap border bg-light form-content small-container">
            ...
            <form method="post" action="{{ route('account-pass.update', Auth::user()->id) }}">
                ...
                <div class="form-group d-flex mb-2 mt-2r">
                    ...
                    <div>
                        <input id="password" type="password" class="form-control @error('password') is-invalid @enderror"
                            name="new_password" pattern=".{8,}" title="Eight or more characters" required
                ...
                <div class="form-group d-flex mb-2">
                    ...
                    <div>
                        <input id="password-confirm" type="password" pattern=".{8,}" title="Eight or more characters"
                            class="form-control" name="confirm_password" required autocomplete="new-password">
                    </div>
                </div>
                <div class="mt-2">

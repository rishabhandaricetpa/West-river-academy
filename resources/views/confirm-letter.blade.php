...
<body>
  <div style="max-width: 1000px; margin: 0 auto;">
    ...
    <p style="font-size: 17px;">Date: August 1, 2020</p>
    ...
    <div class="info-detail" style="margin-top:25px;">
      <p style="margin-top:0;margin-bottom:5px;font-size: 17px;">Name: White Rice</p>
      <p style="margin-top:0;margin-bottom:5px;font-size: 17px;">Date of Birth: January 1, 2004</p>
      <p style="margin-top:0;margin-bottom:5px;font-size: 17px;">Grade: 6</p>
    </div>
    <p style="margin-top:25px;font-size: 17px;">Enrollment Period: August 1, 2020 - July 31, 2021</p>
  </div>
</body>

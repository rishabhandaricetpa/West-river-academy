...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            ...
            <physical-educatiom :physical_education='@json($physical_education)' :student_id='@json($student_id)' :courses_id='@json($courses_id)' :transcript_id='@json($transcript_id)'> </physical-educatiom>
        </div>
    </main>

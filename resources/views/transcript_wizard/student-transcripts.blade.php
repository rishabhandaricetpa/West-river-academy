        ...
        <table class="w-100 table-styling">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    @else
                    <td><a href="{{route('preview.transcript9_12',[$enroll_student->id,$transcriptPayment->transcript_id])}}" class="btn btn-primary disabled">Preview Transcript</a></td>
                    @endif
                    @else
                    @if (getTranscriptPaidDetails($transcriptPayment->id) === 'true')
                    <td><a href="{{route('preview.transcript',[$enroll_student->id,$transcriptPayment->transcript_id])}}" class="btn btn-primary">Preview Transcript</a></td>
                    @else

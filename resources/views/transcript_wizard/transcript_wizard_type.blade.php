    ...
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25">
            <div class="col-sm-6 mx-auto">
                ...
                <form method="post" action="{{ route('transcriptwizard.create', $enroll_student->id) }}"
                    class="mb-0 mt-5 label-large">
                    @csrf
                    <div class="form-group d-sm-flex mb-2">
                        <label for="">First name</label>
                        <div>
                            <input type="text" name="first_name" value="{{ $enroll_student->first_name }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group d-sm-flex mb-2">
                        ...
                        <div>
                            <input type="text" name="middle_name" value="{{ $enroll_student->middle_name }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="form-group d-sm-flex mb-2">
                        ...
                        <div>
                            <input type="text" name="last_name" value="{{ $enroll_student->last_name }}"
                                class="form-control">
                        </div>
                    </div>
                    <div class="mt-2r">
                        ...
                        <div class="d-sm-flex py-4 col-sm-6 mx-auto">
                            ...
                            <input type="hidden" name="type_of_transcript"
                                value="{{ $type ?? '' == 'K-8' ? 'transcript_K-8' : 'transcript_9-12' }}">
                            <div class="form-check mb-1">

...
<body>
  <table>
    <tbody>
      <tr width="100%">
        <td style="width:100%;color:#EC1D1D;font-weight:400;font-size:20px;margin:0 auto;">After this transcript is
          approved by you, any further changes will incure a $25 fee.</td>
      </tr>
    </tbody>
  </table>
  <table style="margin-bottom:20px;">
    <tbody>
      <tr style="width:100%;">
        <td valign="middle" style="text-transform:uppercase;font-weight: 300;font-size:25px;width:50%;height:100px;">
    ...
    <tbody>
      <tr style="width:100%;">
        ...
        <td style="font-weight:700;text-transform:uppercase;text-align:left;font-size:11px;width:50%;line-height:1;">
          {{$student->fullname}}</td>
        <td style="text-transform:uppercase;width:20%;font-size:11px;line-height:1;">date of birth</td>
        <td style="font-weight:700;text-transform:uppercase;text-align:left;width:20%;font-size:11px;line-height:1;">
          {{$student->d_o_b->format(' M y d')}}</td>
      </tr>
    </tbody>
  </table> -->
  <!-- <table>
    <tbody>
      <tr style="width:100%;">
        <td style="text-transform:uppercase;font-size:11px;width:10%;line-height:1;">address</td>
        <td style="font-weight:700;text-transform:uppercase;text-align:left;font-size:11px;width:50%;line-height:1;">
          {{$address->street_address}} {{$address->city}}, {{$address->zip_code}}, {{$address->country}}</td>
  ...
  <!-- <table style="margin-bottom:20px;">
    <tbody>
      <tr style="width:100%;">
        ...
        <td style="font-weight:700;text-transform:uppercase;text-align:left;font-size:11px;width:20%;line-height:1;">4
          and 5</td>
      </tr>
    </tbody>
  </table> -->
      ...
      <tr style="width:100%;">
        <td width="70%">
          <table style="width:100%;border:2px solid #000;border-collapse:collapse;text-transform:uppercase;">
            <thead>
              <tr>
                <th style="border-bottom:1px solid #000;font-size: 11px;font-weight:700;width:70%;padding:3px;">Course
                  name</th>
        ...
        <td width="30%" style="text-align:right;">
          <table width="100%">
            <tbody>
              <tr style="width:100%;">
                <td style="white-space: pre;font-weight:600;text-transform:uppercase;padding-left:52px;"><span
                    style="border-bottom:1px solid #000;display:inline-block;font-size:11px;">GRADING SYSTEM</span></td>
              </tr>
              <tr style="width:100%;">
  ...
  <table style="margin:10px 0 20px;">
    <tbody>
      <tr width="100%">
        <td style="padding-top:20px;width:100%;font-size:12px;">Thi Student has met West River Academy's requirements
          for
          Grades <span style="font-weight:700;">4</span> and <span style="font-weight:700;">5</span> and is promoted to
      ...
      <tr>
        <td valign="bottom" style="text-align:center;width:40%;padding:10px 20px;">
          <img src="../public/images/signature.png"
            style="width:120px;height:auto;object-fit:contain;margin-bottom:-20px;" alt="signatures">
          <span

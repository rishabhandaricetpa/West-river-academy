   ...
   <body>
       ...
       <table width="100%" style="margin-bottom:17px;">
         ...
         <table>
           <tbody>
               <tr style="width:100%;">
                   ...
                   <td
                       style="padding-left:30px;font-weight:700;text-transform:uppercase;text-align:left;font-size:11px;width:50%;line-height:1;">
         ...
         <td width="55%;" style="max-width: 300px;">
         <table>
           <tbody>
               <tr style="width:100%;">

           ...
           <tr>
             <td style="vertical-align:top;width:33.3%;">
               <table style="border:1px solid #000;width:100%;">
                 <tr>
                   <th style="padding:3px 5px;font-size:13px;line-height:1;text-align:left;" width="80%">Total credits
                     earned
                   </th>
             ...
             <td style="vertical-align:top;padding:0 4px 4px 4px; border:1px solid #000;width:33.3%;">
               ...
               <table>
                 <thead>
                   <tr>
                     ...
                     <th style="font-size:13px;text-decoration:underline;text-align:left;white-spaces:nowrap;">AP Points</th>
                   </tr>
                 </thead>
                 <tr>
                 ...
                 <tr>
                   <td style="text-align:center;width:100%;" colspan="2" valign="middle">
                     <span style="margin:10px auto 0;"><img src="../public/images/stamp.png"
                         style="width: 100px;height:100px;object-fit:contain;display:block;" alt="Stamp"></span>
                   </td>
                 </tr>
               </table>
             </td>

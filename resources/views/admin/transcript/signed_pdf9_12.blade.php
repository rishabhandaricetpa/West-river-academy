                   ...
                   <table>
                       <thead>
                           <tr>
                               ...
                               <th
                                   style="font-size:13px;text-decoration:underline;text-align:left;white-spaces:nowrap;">
                                   AP Points</th>
                           </tr>
                       </thead>
                       <tr>
                   ...
                   <table style="width:100%;">
                       ...
                       <tr>
                           <td style="text-align:center;width:100%;" colspan="2" valign="middle">
                               <span style="margin:10px auto 0;"><img src="{{ asset('images/Stamp.png') }}"

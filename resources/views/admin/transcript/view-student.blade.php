                ...
                <div class="col-12">
                    ...
                    <div class="card">
                      ...
                      {{ $student->transcript_id }}</a></td> --}}
                                            ...
                                            <td>{{ getTranscriptStatus($transcripts[0]['transcript_id']) }}</td>
                                            ...
                                            @if ($type == 'k-8')
                                                ...
                                                <td>
                                                    <a
                                                        href=" {{ route('admin.viewfull.transcript', [$transcripts[0]['student_profile_id'], $transcripts[0]['transcript_id']]) }}">
                                            ...
                                            @else
                                                ...
                                                <td>
                                                    <a
                                                        href=" {{ route('admin.viewfull.transcript9_12', [$transcripts[0]['student_profile_id'], $transcripts[0]['transcript_id']]) }}">
                                                        <i class="fas fa-arrow-alt-circle-right"></i></a>
                                                </td>
                                            @endif

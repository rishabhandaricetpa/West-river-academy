...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid position-relative">
            <h1>Transcript Payment List</h1>
            <div class="d-flex">
                <ol class="breadcrumb ml-auto">
                    <li class="breadcrumb-item"><a href="{{ route('admin.dashboard.notification') }}">Home</a></li>
                    <li class="breadcrumb-item active">Transcript Payment List</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.container-fluid -->
    </div>
                                ...
                                <tbody>
                                    @foreach ($getAlltranscriptPayments as $getAlltranscriptPayment)
                                        <tr>
                                            ...
                                            <td><a
                                                    href="{{ route('admin.transpayment.edit', $getAlltranscriptPayment->id) }}"><i
                                                        class="fas fa-edit"></i></a>
                                                <a
                                                    href="{{ route('admin.transpayment.delete', $getAlltranscriptPayment->id) }}"><i

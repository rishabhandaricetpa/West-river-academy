      ...
      <div class="col-12">
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <a href="{{route('admin.other.subjects',$id)}}" class="btn btn-primary">View Other Subjects</a>
            <table id="addressData" class="table table-bordered table-striped data-table"">
              ...
              <a href="{{ url('admin/delete/subject',$subject->id)}}"><i class="fas fa-trash-alt" onclick="return myFunction();"></i></a>
              </td>
              </tr>
              @endforeach
              </tbody>

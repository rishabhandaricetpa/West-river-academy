            ...
            <form method="post" action="{{ route('admin.update.fees',$fees->id) }}">
                ...
                <div class="card-body p-0 row">
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="description" value="{{$fees->description}}" name="description" disabled>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Amount</label>
                        <input type="hidden" class="form-control" id="id" name="id" value="{{$fees->id}}">
                        <input class="form-control" id="amount" name="amount" value="{{$fees->amount}}">
                    </div>
                </div>

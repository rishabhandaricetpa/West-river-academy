      ...
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            <button type="submit" class="btn btn-primary mb-4 mb-sm-0" data-toggle="modal"
              data-target="#moneygramModal">Add New Money Gram Address</button>
                ...
                <tr>
                  ...
                  <td>
                    <a href="{{ url('admin/edit-moneygram',$moneygram->id)}}"><i class="fas fa-edit"></i>
                      <a href="{{ url('admin/delete/moneygram',$moneygram->id)}}"><i class="fas fa-trash-alt"
          ...
          <div class="tab-pane" id="tab_2">
            <button type="submit" class="btn btn-primary mb-4" data-toggle="modal" data-target="#bankTransferModal">Add
              New Bank Transfer Address</button>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('admin/edit-banktransfer',$bankTransfer->id)}}"> <i class="fas fa-edit"></i>
                        <a href="{{ url('admin/delete/banktransfer',$bankTransfer->id)}}"><i class="fas fa-trash-alt"
                            onclick="return myFunction();"></i></a>
                    </td>
                  </tr>
                  @endforeach
          ...
          <div class="tab-pane" id="tab_3">
            <button type="submit" class="btn btn-primary mb-4" data-toggle="modal" data-target="#transferwiseModal">Add
              New Transfer Wise Address</button>
            <div class="overflow-auto">
              <table id="addressData" class="table-styling data-table">
                <thead>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ url('admin/edit-transferwise',$tranferWise->id)}}"><i class="fas fa-edit"></i>
                        <a href="{{ url('admin/delete/transferwise',$tranferWise->id)}}"><i class="fas fa-trash-alt"
                            onclick="return myFunction();"></i></a>
                    </td>
                  </tr>
                  @endforeach
...
<div class="modal fade" id="moneygramModal" tabindex="-1" role="dialog" aria-labelledby="moneygramModalLabel"
  aria-hidden="true">
...
<div class="modal fade" id="bankTransferModal" tabindex="-2" role="dialog" aria-labelledby="bankTransferModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
...
<div class="modal fade" id="transferwiseModal" tabindex="-2" role="dialog" aria-labelledby="transferwiseModalLabel"
  aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">

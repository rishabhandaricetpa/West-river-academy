                ...
                <form method="post" class="row" action="{{ url('admin/update/banktransfer', $banktransfer->id) }}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <select id="status" class="form-control" name="status"
                            value="{{ $banktransfer->status == 1 ? 'Active' : 'Inactive' }}" required>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="swift_code" name="swift_code"
                            value="{{ $banktransfer->swift_code }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Bank Address <sup>*</sup></label>
                        <input class="form-control" id="bank_address" name="bank_address"
                            value="{{ $banktransfer->bank_address }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" name="phone_number" id="phone_number"
                            value="{{ $banktransfer->phone_number }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Routing Number</label>
                        <input class="form-control" id="routing_number" name="routing_number"
                            value="{{ $banktransfer->routing_number }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Account Name</label>
                        <input class="form-control" id="account_name" name="account_name"
                            value="{{ $banktransfer->account_name }}" required>
                    </div>
                    <div class="form-group col-sm-6">
                        <label>Account Number</label>
                        <input class="form-control" id="account_number" name="account_number"
                            value="{{ $banktransfer->account_number }}" required>
                    </div>
                    <!-- /.card-body -->
                    <div class="col-sm-12">

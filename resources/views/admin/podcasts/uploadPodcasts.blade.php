      ...
      <div class="card-body">
        <div class="tab-content">
          <div class="tab-pane active" id="tab_1">
            <form action="{{ route('admin.podcast.store') }}" method="post" class="row" enctype="multipart/form-data">
              @csrf
            ...
            <div class="col-md-6">
              ...
              <p>{{ $podcast->content }}</p>
              <audio id="example_video_1" class="video-js vjs-default-skin vjs-big-play-centered" controls
                preload="auto">
          ...
          <div class="tab-pane" id="tab_2">
            <form method="post" action="{{ route('admin.journal.store') }}" class="row">
              ...
              @if (count($journals) > 0)
              <h2 class="text-center border-top pt-4 mt-3">Uploaded Journal</h2>
          ...
          <div class="tab-pane" id="tab_3">
            <form method="post" action="{{ route('admin.videos.store') }}" class="row" enctype="multipart/form-data">
              @csrf
              <div class="form-group col-md-6">
                <label> HEADING <sup>*</sup></label>
                <input class="form-control" value="" name="heading" required>

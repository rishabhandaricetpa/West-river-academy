        ...
        <div class="container-fluid position-relative">
            ...
            <div class="form-wrap border py-5 px-25 position-relative">
                ...
                <h3 class="pr-3"> Payment Status of Parent: <a
                        href="{{ route('admin.parent.edit', $customLetter->parent_profile_id) }}">{{ $customLetter->ParentProfile->p1_first_name . ' ' }}{{ $customLetter->ParentProfile->p1_last_name }}</a>
                </h3>
                <form method="post" class="row" action="{{ route('admin.update.customletter', $customLetter->id) }}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="amount" type="number" min="0" value="{{ $customLetter->amount }}"
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <textarea class="form-control" id="paying_for" value="{{ $customLetter->paying_for }}"
                            name="paying_for" onKeyPress="if(this.value.length==2000) return false;"
                            maxlength="2000">{{ $customLetter->paying_for }}</textarea>
                    </div>
                    @if ($transactionData)
                        <div class="form-group col-sm-6">

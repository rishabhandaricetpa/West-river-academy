...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid position-relative">
            <h1>Order Consultation Details</h1>
            <div class="form-wrap border py-5 px-25 position-relative">
                <!-- form start -->
                <h3 class="pr-3"> Payment Status of Parent: <a
                        href="{{ route('admin.parent.edit', $order_conultation->parent_profile_id) }}">{{ $order_conultation->parent->full_name }}
                    </a>
                </h3>
                <form method="post" class="row" action="{{ route('admin.update.conultation', $order_conultation->id) }}">
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" id="amount" value="{{ $order_conultation->preferred_language }}"
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <textarea class="form-control" id="amount" value="{{ $order_conultation->consulting_about }}"
                            name="consulting_about" maxlength="2000"
                            onKeyPress="if(this.value.length==2000) return false;"></textarea>
                    </div>
                    <div class="form-group col-sm-6">
                        ...
                        <select name="paymentStatus" class="form-control">
                            ...
                            <option value="paid" @if ($order_conultation->status == 'paid') selected="selected" @endif>Paid</option>
                        </select>
                    </div>
                    @if ($transactionData)
                        <div class="form-group col-sm-6">

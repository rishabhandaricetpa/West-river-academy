        ...
        <div class="form-wrap border py-5 px-25 position-relative">
            ...
            <form method="post" class="row" action="{{route('admin.update-payment',$enroll_payment->id)}}">
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input class="form-control" id="amount" value="{{$enroll_payment->amount}}" name="amount">
                </div>
                ...
                <div class="form-group col-sm-6">
                    ...
                    <input class="form-control" id="transcation_id" value="{{$enroll_payment->transcation_id}}" name="transcation_id">
                    @else
                    <label>Transcation ID <sup>*</sup></label>
                    <input class="form-control" id="transcation_id" value="{{$enroll_payment->transcation_id}}" name="transcation_id" readonly>
                    @endif

...
<section class="content container-fluid  my-1">
  ...
  <div class="rep-list bg-white py-3 px-2 overflow-auto">
    <button type="button" class="btn btn-primary btn-modal ml-3" data-toggle="modal" data-target="#addrep-list-Modal"
    data-whatever="@getbootstrap"><span>Add Rep</span><img src="/images.add.png" alt="">
  </button>
        ...
        <div class="modal-body">
          <form id="add-new-enrollments">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                <input type="hidden" value="" id='student_name_enroll' name="student_name" class="form-control">
              </div>
              <div class="form-group  col-md-6">

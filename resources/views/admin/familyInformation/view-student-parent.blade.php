                            ...
                            <table id="student-parent" class="table table-bordered table-striped data-table"">
                                      ...
                                      <td>{{$parent->p1_first_name}}</td>
                                       ...
                                       @else
                                          <td>Inactive User</td>
                                            @endif
                                           <td><a href="{{route('admin.parent.edit',$parent->id)}}"><i class="fas fa-edit"></i></a>
                                           <a href="{{route('admin.deactive.student',$parent->id)}}"><i class="fas fa-ban"></i></a>
                                           <a href="{{route('admin.parent.delete',$parent->id)}}"><i class="fas fa-trash-alt"></i></a>
                                           </td>

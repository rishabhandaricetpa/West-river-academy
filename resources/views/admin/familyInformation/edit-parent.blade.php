            ...
            <table class="table table-striped table-styling w-100 table-vertical_scroll">
              <thead class="thead-light">
                <tr>
                  ...
                  <th scope="col" class="text-right"><button type="button" class="btn btn-primary btn-modal ml-auto"
                      data-toggle="modal" data-target="#groupModal" data-whatever="@getbootstrap">Choose
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td class="text-right"><a href="javascript:void(0)" class="btn btn-primary btn-modal ml-3"
                        data-toggle="modal" data-target="#order-details_details" data-whatever="@getbootstrap"
                        data-id={{ $detail_order_list->transcation_id }} onclick="detailOrders(event.target)">View
                        Order</a></td>
                  </tr>
                  @endforeach

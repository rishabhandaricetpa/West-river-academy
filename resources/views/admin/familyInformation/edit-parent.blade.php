                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea style="height:120px;" id="notes_val"
                                        ...
                                        <div class="col-12 order-detail_OrderPostage-paid display-none"
                                            id="order-detail_OrderPostage-paid">
                                            <div class="row">
                                                <div class="col-lg-6 col-12 ">
                                                    <div class="form-group">
                                                        <label for="message-text" class="col-form-label">Payment
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea style="height:120px;" id="notar_notes"
                                                    class="form-control"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">

          ...
          <form class="is-readonly row" id="sampleForm">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="street_address" placeholder="" name="street_address"
            ...
            <table class="table table-striped table-styling w-100 table-vertical_scroll">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td>{{ $student->email }}</td>
                  <td><a href="{{route('admin.delete.student',$student->id)}}"><i class="fas fa-trash-alt"></i></a></td>
                  <td></td>
                </tr>
                @endforeach
              </tbody>
          ...
          <table class="table table-striped table-styling w-100 table-vertical_scroll">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $values }}</td>
                <td><a
                    href=" {{ route('admin.allorders', [$transcation->transcation_id, $transcation->parent_profile_id]) }}"><i class=" fas fa-edit"
                    onclick="return myFunction();"></i></a></br></td>
                <td></td>
              </tr>
              @endforeach
            </tbody>

            ...
            <form class="is-readonly row" id="sampleForm">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" placeholder="" id="p2_street_address"
                    value="{{ $parent->p2_street_address }}" name="street2" disabled>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label for="exampleInputEmail1">City :</label>
                      <input type="text" class="form-control is-disabled" placeholder="" value="{{ $parent->p2_city }}"
                        id="p2_city" disabled>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputEmail1">State :</label>
                      <input type="text" class="form-control is-disabled" placeholder="" value="{{ $parent->p2_state }}"
                        id="p2_state" disabled>
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
    ...
    <div class="row my-2 ">
            ...
            <thead class="thead-light">
              <tr>
                ...
                <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-auto"
                    data-toggle="modal" data-target="#RepsModal" data-whatever="@getbootstrap"><img
                      src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button>
                </th>
                <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-auto"
                    data-toggle="modal" data-target="#groupModal" data-whatever="@getbootstrap"><img
                      src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button>
                </th>
              </tr>
            </thead>
      ...
      <div class="modal fade bd-example-modal-lg" id="RepsModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="RepsModalLabel">Add Reps/Group</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              <form id="add-new-student">
                <div class="row">
                  <div class="col-lg-6 col-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" type="text" id=''>
                        <option value="">Respresentative Group</option>
                  ...
                  <div class="col-lg-6 col-12">
                    <div class="form-group">
                      <label for="message-text" class="col-form-label">Nmae of Reps/Group
                      </label>
                      <input type="text" id="" class="form-control">
                    </div>
                  </div>
                  <div class="col-lg-6 col-12">
                    <div class="form-group">
                      <label for="message-text" class="col-form-label">Administrator of Group</label>
                      <input type="text" id="" class="form-control">
                    </div>
                  </div>
      ...
      <div class="modal fade bd-example-modal-lg" id="groupModal" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-lg" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="groupModalLabel">Add Reps/Group</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                                    ...
                                    @foreach ($payment_info as $payment)
                                        <tr>
                                            ...
                                            <td class="d-flex align-items-center">
                                                <a  class="mr-1" href=" {{ route('admin.edit.payment.status', $payment->id) }}"><i
...
>>>>>>> d6fa0e775333d978753e61389810b96104636a13
                ...
                <div class="col-12">
                  <div class="form-group lato-italic info-detail">
                    ...
                    <div class="row">
                      <div class="col-6">
                        <div class="form-check" required>
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]"
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="1"
                            required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            1
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="2"
                            required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            2
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="3"
                            required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            3
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="4"
                            required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            4
                          </label>
                      ...
                      <div class="col-6">
                        <div class="form-check">
                          <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="5"
                            required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            5
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="6" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            6
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="7" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            7
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="8" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            8
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="9" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            9
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="10" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            10
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="11" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            11
                          </label>
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" value="12" name="grade_level[]"
                            id="grade_level[]">
                          <label class="form-check-label pl-1 pl-sm-0">
                            12
                          </label>

                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="add-new-student">
                                ...
                                <div class="form-group">
                                    <label for="recipient-name" class="col-form-label">First/Given Name :</label>
                                ...
                                <div class="form-group">
                                    <label for="message-text" class="col-form-label">Cell Phone
                                    </label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="immunized_status">
                                </div>

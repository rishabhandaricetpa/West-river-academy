                    ...
                    <div class="tab-content">
                      <d class="tab-pane fade show active" id="first" role="tabpanel" aria-labelledby="student-tab">
                        ...
                        <div class="d-flex align-items-center pt-4">
                          <a href="{{ route('admin.edit-student',$student->id)}}" class="btn btn-primary ml-auto">View
                            Student Details</a>
                        </div>
                        <div class="seperator">
        ...
        <div class="tabbable-responsive">
          <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              ...
              <li class="nav-item">
                <a class="nav-link" id="parent2" data-toggle="tab" href="#sixth" role="tab" aria-controls="sixth"
                  aria-selected="false">Document</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="login" data-toggle="tab" href="#sixth" role="tab" aria-controls="sixth"

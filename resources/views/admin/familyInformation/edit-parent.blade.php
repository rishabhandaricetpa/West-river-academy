...
<section class="content container-fluid  my-3">
    ...
    <div class="card my-3 family-details">
        <div class="sticky mb-2 pb-1">
            ...
            <ul class="nav overflow-auto align-items-center">
                ...
                <li class="nav-item"><a href="#" class="add-menu-item nav-link" data-toggle="modal" data-target="#parentDetailsModal" data-whatever="@getbootstrap">
        ...
        <div class="modal fade bd-example-modal-lg pt-4" id="parentDetailsModal" tabindex="-1" role="dialog" aria-labelledby="parentDetailsModalLabel" aria-hidden="true">
    ...
    <div class="px-3" id="to-the-top">
                        ...
                        <form class="is-readonly row" id="sampleForm">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-disabled" name="p1_first_name" id="p1_first_name" placeholder="" value="{{ $parent->p1_first_name }}" disabled required>
                                </div>
                                <div class="form-group">
                                    <input type='hidden' id="parent_id" name="parent_id" value="{{ $parent->id }}">
                                    <label for="p1_middle_name">Middle Name :</label>
                                    <input type="text" class="form-control is-disabled" name="p1_middle_name" id="p1_middle_name" placeholder="" value="{{ $parent->p1_middle_name }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="p1_last_name">Last Name :</label>
                                    <input type="text" class="form-control is-disabled" name="p1_last_name" id="p1_last_name" placeholder="" value="{{ $parent->p1_last_name }}" disabled required>
                                </div>
                                <div class="form-group">
                                    <label for="p1_email">Email :</label>
                                    <input type="email" class="form-control is-disabled" name="p1_email" id="p1_email" placeholder="" value="{{ $parent->p1_email }}" disabled required>
                                </div>
                                <div class="form-group">
                                    <label for="p1_cell_phone">Phone :</label>
                                    <input type="text" class="form-control is-disabled" name="p1_cell_phone" id="p1_cell_phone" placeholder="" value="{{ $parent->p1_cell_phone }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="p1_home_phone"> Home Phone :</label>
                                    <input type="text" class="form-control is-disabled" name="p1_home_phone" id="p1_home_phone" placeholder="" value="{{ $parent->p1_home_phone }}" disabled>
                                </div>
                                <h3 class="mt-3">Address</h3>
                                <div class="form-group">
                                    <label for="street_address">Street :</label>
                                    <input type="text" class="form-control is-disabled" id="street_address" placeholder="" name="street_address" value="{{ $parent->street_address }}" disabled required>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">City :</label>
                                            <input type="text" class="form-control is-disabled" id="city" placeholder="" name="city" value="{{ $parent->city }}" disabled required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">State :</label>
                                            <input type="text" class="form-control is-disabled" id="state" placeholder="" name="state" value="{{ $parent->state }}" disabled required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Country :</label>
                                            <input type="text" class="form-control is-disabled" id="country" placeholder="" name="country" value="{{ $parent->country }}" disabled required>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Zip Code :</label>
                                            <input type="text" class="form-control is-disabled" id="zip_code" placeholder="" name="state" value="{{ $parent->zip_code }}" disabled required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-disabled" id="p2_first_name" placeholder="" value="{{ $parent->p2_first_name }}" name="p2_first_name" disabled>
                                </div>
                                <div class=" form-group">
                                    <label for="exampleInputPassword1">Middle Name :</label>
                                    <input type="text" class="form-control is-disabled" id="p2_middle_name" placeholder="" name="p2_middle_name" value="{{ $parent->p2_middle_name }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Last Name :</label>
                                    <input type="text" class="form-control is-disabled" id="p2_last_name" placeholder="" name="p2_last_name" value="{{ $parent->p2_last_name }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Email :</label>
                                    <input type="email" class="form-control is-disabled" id="p2_email" placeholder="" name="p2_email" value="{{ $parent->p2_email }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Phone :</label>
                                    <input type="email" class="form-control is-disabled" name="p2_cell_phone" id="p2_cell_phone" placeholder="" value="{{ $parent->p2_cell_phone }}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Home Phone :</label>
                                    <input type="email" class="form-control is-disabled" name="p2_home_phone" id="p2_home_phone" placeholder="" value="{{ $parent->p2_home_phone }}" disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control is-disabled" placeholder="" id="p2_street_address" value="{{ $parent->p2_street_address }}" name="street2" disabled>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">State :</label>
                                            <input type="text" class="form-control is-disabled" placeholder="" value="{{ $parent->p2_state }}" id="p2_state" disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Country :</label>
                                            <input type="text" class="form-control is-disabled" placeholder="" value="{{ $parent->p2_country }}" id="p2_country" disabled>
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Zip code :</label>
                                            <input type="text" class="form-control is-disabled" placeholder="" value="{{ $parent->p2_zip_code }}" id="p2_zip_code" disabled>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row my-2 ">
                    ...
                    <table class="table table-striped table-styling w-100 table-vertical_scroll">
                        <thead class="thead-light">
                            <tr>
                                ...
                                <th scope="col" class="text-right"><button type="button" class="btn btn-primary btn-modal ml-auto" data-toggle="modal" data-target="#RepsModal" data-whatever="@getbootstrap">Add
                                        new Rep</button>
                                </th>
                                <th scope="col" class="text-right"><button type="button" class="btn btn-primary btn-modal ml-auto" data-toggle="modal" data-target="#groupModal" data-whatever="@getbootstrap">Choose Rep</button>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
            ...
            <div class="modal fade bd-example-modal-lg" id="RepsModal" tabindex="-1" role="dialog" aria-labelledby="RepsModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
            ...
            <div class="modal fade bd-example-modal-lg" id="groupModal" tabindex="-1" role="dialog" aria-labelledby="groupModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <table class="table table-striped table-styling w-100 table-vertical_scroll">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col">Email</th>
                                    <th>Delete</th>
                                    <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-auto" data-toggle="modal" data-target="#studentDetailsModal" data-whatever="@getbootstrap"><img src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button>
                                    </th>
                                </tr>
                            </thead>
        ...
        <div class="modal fade bd-example-modal-lg" id="studentDetailsModal" tabindex="-1" role="dialog" aria-labelledby="studentDetailsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <table class="table table-striped table-styling w-100 table-vertical_scroll">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-3" data-toggle="modal" data-target="#notesModal" data-whatever="@getbootstrap"><img src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button></th>
                                </tr>
                            </thead>
                            <tbody>
        ...
        <div class="modal fade bd-example-modal-lg" id="notesModal" tabindex="-1" role="dialog" aria-labelledby="#notesModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <table class="table table-striped table-styling w-100 table-vertical_scroll">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-3" data-toggle="modal" data-target="#enrollmentsModal" data-whatever="@getbootstrap"><img src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button></th>
                                </tr>
                            </thead>
                            <tbody>
                                {{-- {{dd($payment_info)}} --}}
        ...
        <div class="modal fade bd-example-modal-lg" id="enrollmentsModal" tabindex="-1" role="dialog" aria-labelledby="enrollmentsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check" required>
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="Ungraded" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        Ungraded
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="Preschool Age 3">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        Preschool Age 3
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="Preschool Age 4">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        Preschool Age 4
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="Kindergarten" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        Kindergarten
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="1" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        1
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="2" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        2
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="3" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        3
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="4" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        4
                                                    </label>
                                                </div>
                                            ...
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" id="grade_level[]" name="grade_level[]" value="5" required>
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        5
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="6" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        6
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="7" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        7
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="8" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        8
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="9" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        9
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="10" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        10
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="11" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        11
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" value="12" name="grade_level[]" id="grade_level[]">
                                                    <label class="form-check-label pl-1 pl-sm-0">
                                                        12
                                                    </label>
                                                </div>
        ...
        <div class="modal fade bd-example-modal-lg" id="recordsModal" tabindex="-1" role="dialog" aria-labelledby="recordsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <form id="add-record-request">
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="school_name" id="recipient-name" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="message-text" class="col-form-label">Email Address:</label>
                        ...
                        <table class="table table-striped table-styling w-100 table-vertical_scroll">
                            <thead class="thead-light">
                                <tr>
                                    ...
                                    <th scope="col" class="text-right"> <button type="button" class="btn btn-modal ml-3" data-toggle="modal" data-target="#documentsModal" data-whatever="@getbootstrap"><img src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button></th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href=" {{ route('admin.edit.uploadedDocument', $document->id) }}">Edit
                                            Document</a></br></td>
                                    <td>
                                        <a href=" {{ route('admin.edit.upload', $document->student_profile_id) }}">Upload
                                            Documents</a></br>
        ...
        <div class="modal fade bd-example-modal-lg" id="documentsModal" tabindex="-1" role="dialog" aria-labelledby="documentsModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <table class="table table-striped table-styling w-100 table-vertical_scroll">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href=" {{ route('admin.edit.payment.status', $data->student->id) }}">New
                                    ...
                                    <td><a href="{{ route('admin.student.schoolRecord', [$data->student_profile_id, $data['recordTransfer']['id']]) }}">Record
                                            Transfer</a></td>
                                    ...
                                    <td><a href="{{ route('admin.each.notarization', $data->linked_to) }}" class="transform-none">Notarization
                                            or Apostille</a></td>

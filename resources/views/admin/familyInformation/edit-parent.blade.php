...
<section class="content container-fluid  my-3">
  ...
  <div class="card family-details px-3 my-3">
    <ul class="nav overflow-auto" id="to-the-top">
      ...
      <div>
        <a class="p-2" href="#"><img src="/images/back-button.png" alt=""></a>
      </div>
    </ul>
    <div class="row parent-detail_page py-2 mb-2">
      <div class="col-12 d-flex align-items-center">
        <h2 class="pr-2">{{ $parent->p1_first_name }} {{ $parent->p1_middle_name }}
    ...
    {{-- student-details --}}
    <section class="parents-details py-3 my-2" id="student-details">
      <div class="row">
        <div class="col-12">
          ...
          <div class="modal-body">
            <form id="add-new-student">
              <div class="row">
                ...
                <div class="col-12">
                  <div class="form-group lato-italic info-detail d-sm-flex">
    ...
    {{-- notes --}}
    <section class="notes  py-3 my-2" id="notes">
      <div class="row">
        <div class="col-12">
    ...
    {{-- order --}}
    <section class="orders-detail  py-3 my-2" id="orders">
      <div class="row">
        <div class="col-12">
    ...
    {{-- Enrollments --}}
    <section class="enrollments  py-3 my-2" id="enrollments">
      <div class="row">
        <div class="col-12">
    ...
    {{-- Records --}}
    <section class="records  py-3 my-2" id="records">
      <div class="row">
        <div class="col-12">
    ...
    {{-- Documents --}}
    <section class="documents  py-3 my-2" id="documents">
      <div class="row">
        <div class="col-12">

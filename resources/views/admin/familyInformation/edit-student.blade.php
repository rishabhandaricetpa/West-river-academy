        ...
        <section class="students-details pt-2 pb-5" id="student-details">
          <div class="tab-content">
            ...
            <div class="row">
              ...
              {{-- student detil-1 --}}
              <div class="col-md-12">
                <form class="is-readonly row students_store edit-student-profile" id="studentForm1">
                  <div class="col-md-6">
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="form-group lato-italic info-detail d-flex">
                        ...
                        <div class="form-check">
                          <input class="form-check-input" type="radio" name="student_gender" id="student_gender"
                            value="Male" required>
                          <label class="form-check-label pl-1 pl-sm-0">
                            Male
                          </label>
            ...
            <div class="modal fade bd-example-modal-lg" id="Student-activityModal" tabindex="-1" role="dialog"
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body py-2 px-sm-4 px-2">
                  ...
                  <div class="modal-footer py-2 px-sm-4 px-2">
                    <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
                    <button type="submit" class="btn btn-primary">Save</button>
                  </div>
                  </form>
                            ...
                            <div class="row">
                              <div class="col-6">
                                ...
                                <div class="form-check" required>
                                  <input class="form-check-input" type="radio" id="grade_level[]" value="Ungraded"
                                    required>
                                  <label class="form-check-label pl-1 pl-sm-0">
                                    Ungraded
                                  </label>

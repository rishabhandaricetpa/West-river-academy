...
<section class="content p-0">
  ...
  <div class="card family-details  pb-3 mb-0">
    <div class="sticky mb-2 p-1 pt-2 px-3">
      {{-- @include('admin.familyInformation.student_header') --}}
      <div class="row">
        <div class="col-12 d-flex align-items-center">
          <h2 class="pr-3"><a href="{{ route('admin.parent.edit', $parent_id) }}">{{ $parent->p1_first_name }}
    ...
    {{-- students-details --}}
    <section class="students-details pt-2 pb-5 px-3" id="student-details">
            ...
            <form class="is-readonly row students_store" id="studentForm1" class="edit-student-profile">
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="middle_name" placeholder=""
                ...
                <div class="form-group lato-italic info-detail d-flex py-1">
                  ...
                  <div class="d-flex">
                    <div class="form-check">
                      <input class="form-check-input mt-1" type="radio" name="gender" id="gender" value="Male"
                        {{ $student->gender == 'Male' ? 'checked' : '' }} required disabled>
                      <label class="form-check-label pl-1 pl-sm-0">
                        Male
                      </label>
                    </div>
                    <div class="form-check">
                      <input class="form-check-input mt-1" type="radio" name="gender" value="Female"
                        {{ $student->gender == 'Female' ? 'checked' : '' }} id="gender" disabled>
                      <label class="form-check-label pl-1 pl-sm-0">
                        Female
                      </label>
                    </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="national_ID" placeholder=""
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="p1_name" placeholder="Name"
                    value="{{ $parent->p1_first_name }} {{ $parent->p1_last_name }}" readonly disabled>
                </div>
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="p2_last_name" placeholder="Name"
                    value="{{ $parent->p2_first_name }} {{ $parent->p2_last_name }}" readonly disabled>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control is-disabled" id="immunized_status" placeholder=""
                    value="{{ $student->immunized_status }}" readonly disabled>
                </div>
                <div class="form-group">
                  <label for="exampleInputEnrolled">Enrolled :</label>
                  @if ($enrollment_periods)
                  <input type="text" class="form-control is-disabled" id="enrollment" placeholder="Name" value="Yes"
                    readonly disabled>
                  @else
                  <input type="text" class="form-control is-disabled" id="enrollment" placeholder="Name" value="No"
                    readonly disabled>
                  @endif
                </div>
                <div class="form-group">
                  ...
                  @if ($graduations)
                  <input type="text" class="form-control is-disabled" id="graduation" placeholder="Yes" value="Yes"
                    readonly disabled>
                  @else
                  <input type="text" class="form-control is-disabled" id="graduation" placeholder="No" value="No"
                    readonly disabled>
                  @endif
                </div>
                <div class="form-group">
          ...
          <form id="new-student-record">
            <div class="modal-body">
              <div class="row">
                ...
                <input type="hidden" value="{{ $student->id }}" id='student' name="student-name" class="form-control">
                ...
                <div class="col-12">
                  <div class="form-group lato-italic info-detail d-flex">
                    ...
                    <div class="form-check">
                      <input class="form-check-input mt-0" type="radio" name="student_gender" id="student_gender"
                        value="Male" required>
                      <label class="form-check-label pl-1 pl-sm-0">
                        Male
                      </label>
                    ...
                    <div class="form-check">
                      <input class="form-check-input mt-0" type="radio" name="student_gender" value="Female"
                        id="gender">
                      <label class="form-check-label pl-1 pl-sm-0">
                        Female
                      </label>
    ...
    <nav class="student-detail_documents">
      <div class="nav nav-tabs justify-content-start" id="nav-tab" role="tablist">
        <a class="nav-link active" id="studentActivity-tab" data-toggle="tab" href="#studentActivity" role="tab"
          aria-controls="studentActivity" aria-selected="true">Activity</a>
        <a class="nav-link" id="studentEnrollments-tab" data-toggle="tab" href="#studentEnrollments" role="tab"
          aria-controls="studentEnrollments" aria-selected="false">Enrollments</a>
        <a class="nav-link" id="studentTranscript-tab" data-toggle="tab" href="#studentTranscript" role="tab"
          aria-controls="studentTranscript" aria-selected="false">Transcript</a>
        ...
        <a class="nav-link" id="studentDocuments-tab" data-toggle="tab" href="#studentDocuments" role="tab"
          aria-controls="studentDocuments" aria-selected="false">Documents</a>
      </div>
    </nav>
    <div class="tab-content" id="nav-tabContent">
      {{-- activities --}}
      <div class="tab-pane fade show active" id="studentActivity" role="tabpanel" aria-labelledby="studentActivity-tab">
        {{-- Student-activity --}}
                  ...
                  <thead class="thead-light min-width">
                    <tr>
                      ...
                      <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-3"
                          data-toggle="modal" data-target="#Student-activityModal" data-whatever="@getbootstrap"><img
            ...
            <div class="modal-content">
              ...
              <form id="add-new-notes">
                <div class="modal-body py-2 px-md-4 px-2">
                  <div class="form-group">
                    <input type="hidden" value="{{ $student->id }}" id="student_name_for_notes">
                    <input class="form-control" type="hidden" value="{{ $parent->id }}" id='parent_id'>
                  </div>
                  <div class="form-group">
                    <label for="message-text" class="col-form-label">Notes:</label>
                    <textarea id="message_text" class="form-control" id="message_text" required
      ...
      {{-- enrollments --}}
      <div class="tab-pane fade" id="studentEnrollments" role="tabpanel" aria-labelledby="studentEnrollments-tab">
                  ...
                  <thead class="thead-light min-width">
                    <tr>
                      ...
                      <th scope="col" class="text-right"><a
                          href="{{ route('admin.update.allenrollment', $student->id) }}" class="btn btn-primary">
              ...
              <form id="add-new-enrollments">
                <div class="modal-body">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-md-6">
                      <input type="hidden" value="{{ $student->id }}" id='student_name_enroll' name="student_name"
                        class="form-control">
                    </div>
                    <div class="form-group  col-md-6">
                        ...
                        <div class="row">
                          <div class="col-6">
                            ...
                            <div class="form-check" required>
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" id="grade_level[]"
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="6"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                6
                              </label>
                          ...
                          <div class="col-6">
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="7"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                7
                              </label>
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="8"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                8
                              </label>
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="9"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                9
                              </label>
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="10"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                10
                              </label>
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="11"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                11
                              </label>
                            ...
                            <div class="form-check">
                              <input class="form-check-input mt-1" type="radio" name="grade_level[]" value="12"
                                id="grade_level[]">
                              <label class="form-check-label pl-1 pl-sm-0">
                                12
                              </label>
      ...
      {{-- transcript --}}
      <div class="tab-pane fade" id="studentTranscript" role="tabpanel" aria-labelledby="studentTranscript-tab">
                ...
                <table class="table table-striped table-styling w-100 table-vertical_scroll">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td> <a href="{{ route('admin.transpayment.edit', $transcript['transcriptPayment']['id']) }}">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form id="add-transcript">
                <div class="modal-body">
                  <div class="row">
                    <input type="hidden" value="{{ $student->id }}" id='std_id' name="student-name"
                      class="form-control">
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="form-group">
                        ...
                        <select id="transcript_period" class="form-control" required onchange="getTranscriptval();">
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="form-group">
                        ...
                        <select type="" id="amount" class="form-control" required onchange="getTotalTranscript();">
                          <option value="">Select...</option>
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="form-group">
                        ...
                        <select type="" id="status" class="form-control paymentDisplay" required>
                          <option value="">Select</option>
                    ...
                    <div class="col-lg-6 col-12">
                      <div class="form-group transction-div">
                        <label for="message-text" class="col-form-label">Transaction
                          ID</label>
                        <input type="text" id="transcript_transaction_id" class="form-control custom_letter_transction">
                      </div>
                    </div>
                    <div class="col-lg-6 col-12">
                      <div class="form-group payment-div">
                        <label for="message-text" class="col-form-label">Payment
                          Mode</label>
                        <select type="" id="transcript_pay_mode" class="form-control custom_letter_payment_mode">
          ...
          <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
              ...
              <form id="add-record-request">
                <div class="modal-body">
                  <div class="row">
                    <input type="hidden" value="{{ $student->id }}" id='record_student_id' name="student-name"
                      class="form-control">
      ...
      {{-- documents --}}
      <div class="tab-pane fade" id="studentDocuments" role="tabpanel" aria-labelledby="studentDocuments-tab">

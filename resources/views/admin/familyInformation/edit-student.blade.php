      ...
      <form method="post" class="row" action="{{ route('admin.edit-student.update', $student->id) }}"
        ...
        <div class="form-group col-sm-6">
          ...
          <div class="position-relative w-100"> <i class="fas fa-calendar-alt" aria-hidden="true"></i><input
              class="form-control datepicker" id="dob" name="dob" value="{{ $student->d_o_b->format('M d Y') }}"
              required></div>
        </div>
        <div class="form-group col-sm-6">
        ...
        <div class="form-group w-100 row mx-0">
          ...
          <div class="col-md-4 mb-4 mb-sm-0">
            ...
            <select name="grade[]" class="form-control">
              <option value="Ungraded" @if ($enrollment_period->grade_level == 'Ungraded') selected="selected"
              ...
              <option class="form-control" value="1" @if ($enrollment_period->grade_level == '1') selected="selected"
                @endif>1</option>

              <option class="form-control" value="2" @if ($enrollment_period->grade_level == '2') selected="selected"
                @endif>2</option>

              <option class="form-control" value="3" @if ($enrollment_period->grade_level == '3') selected="selected"
                @endif>3</option>

              <option class="form-control" value="4" @if ($enrollment_period->grade_level == '4') selected="selected"
                @endif>4</option>

              <option class="form-control" value="5" @if ($enrollment_period->grade_level == '5') selected="selected"
                @endif>5</option>

              <option class="form-control" value="6" @if ($enrollment_period->grade_level == '6') selected="selected"
                @endif>6</option>

              <option class="form-control" value="7" @if ($enrollment_period->grade_level == '7') selected="selected"
                @endif>7</option>

              <option class="form-control" value="8" @if ($enrollment_period->grade_level == '8') selected="selected"
                @endif>8</option>

              <option class="form-control" value="9" @if ($enrollment_period->grade_level == '9') selected="selected"
                @endif>9</option>
        ...
        <div class="tabbable-responsive">
          <div class="tabbable">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
              <li class="nav-item">
                <a class="nav-link active" id="student1" data-toggle="tab" href="#first" role="tab"
                  aria-controls="first" aria-selected="true">Student 1</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" id="student2" data-toggle="tab" href="#sixth" role="tab" aria-controls="sixth"
                  aria-selected="false">Student 2 </a>
              </li>
              <li class="nav-item">
        ...
        <div class="tab-content">
          <div class="tab-pane fade show active" id="first" role="tabpanel" aria-labelledby="student1">
            <div class="form-group col-12">
              <label>Student1 First/Given Name <sup>*</sup></label>
              <input class="form-control" id="p1_first_name" name="p1_first_name">
            </div>
            <div class="form-group col-12">
            ...
            <div class="form-group col-12">
              ...
              <input class="form-control" id="p1_email" name="p1_email" disabled>
            </div>
            <div class="form-group col-12">
          ...
          <div class="tab-pane fade" id="sixth" role="tabpanel" aria-labelledby="parent2">
            <div class="form-group col-12">
              ...
              <input class="form-control" id="p2_first_name" name="p2_first_name">
            </div>
            <div class="form-group col-12">

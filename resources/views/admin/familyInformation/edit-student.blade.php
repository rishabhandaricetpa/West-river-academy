                                    ...
                                    <div class="form-group lato-italic info-detail d-flex py-1">
                                        ...
                                        <div class="d-flex">
                                            <div class="form-check">
                                                <input class="form-check-input mt-1" type="radio" name="gender" id="gender"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="p1_name" placeholder="Name"
                                            value="{{ $parent->p1_first_name }} {{ $parent->p1_last_name }}" readonly
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="p2_last_name"
                                            placeholder="Name"
                                            value="{{ $parent->p2_first_name }} {{ $parent->p2_last_name }}" readonly
                                            disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="immunized_status"
                                            placeholder="" value="{{ $student->immunized_status }}" readonly disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea type="email" class="form-control is-disabled" id="student_situation"
                                            placeholder="" value="{{ $student->student_situation }}" disabled></textarea>
                                    </div>
                                </div>
                        ...
                        <form id="new-student-record">
                            <div class="modal-body">
                                <div class="row">
                                    ...
                                    <input type="hidden" value="{{ $student->id }}" id='student' name="student-name"
                                        class="form-control">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group lato-italic info-detail d-flex">
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input mt-0" type="radio" name="student_gender"
                                                    id="student_gender" value="Male" required>
                                                <label class="form-check-label pl-1 pl-sm-0">
                                                    Male
                                                </label>
                                            </div>
                                    ...
                                    <table class="table table-striped table-styling w-100 table-vertical_scroll">
                                        <thead class="thead-light min-width">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-right"><button type="button"
                                                        class="btn btn-modal ml-3" data-toggle="modal"
                                                        data-target="#enrollmentsModal" data-whatever="@getbootstrap"><img
                                ...
                                <form id="add-new-enrollments">
                                    <div class="modal-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <input type="hidden" value="{{ $student->id }}" id='student_name_enroll'
                                    ...
                                    <table class="table table-striped table-styling w-100 table-vertical_scroll">
                                        <thead class="thead-light min-width">
                                            <tr>
                                                ...
                                                <th scope="col" class="text-right"><button type="button"
                                                        class="btn btn-modal ml-3" data-toggle="modal"
                                                        data-target="#recordsModal" data-whatever="@getbootstrap"><img
                                                            src="/images/add.png" alt=""><img src="/images.add.png"
                                                            alt=""></button>
                                                </th>
                                            </tr>
                                        ...
                                        <tbody>
                                            @foreach ($recordTransfer as $records)
                                                <tr>
                                                    ...
                                                    <td><a class="lowercase" href="mailto:${{ $records->email }}">
                                                            {{ $records->email }}</a></td>
                        ...
                        <div class="modal-dialog modal-lg" role="document">
                            <div class="modal-content">
                                ...
                                <form id="add-record-request">
                                    <div class="modal-body">
                                        <div class="row">
                                            <input type="hidden" value="{{ $student->id }}" id='record_student_id'
                                                name="student-name" class="form-control">

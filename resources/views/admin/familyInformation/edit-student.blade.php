                            ...
                            <form class="is-readonly row" id="sampleForm">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="exampleInputDOB"
                                            placeholder="MM/DD/YYYY" value="MM/DD/YYYY" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputGender">Gender:</label>
                                        <input type="text" class="form-control is-disabled" id="exampleInputMothersName"
                                            placeholder="Male" value="Male" disabled>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="exampleInputStatus"
                                            placeholder="Male" value="Male" disabled>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control is-disabled" id="exampleInputParent1"
                                            placeholder="Name" value="Benjamin" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputParent2">Parent - 2 :</label>
                                        <input type="text" class="form-control is-disabled" id="exampleInputParent2"
                                            placeholder="Name" value="David" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputEnrolled">Enrolled :</label>
                                        <input type="text" class="form-control is-disabled" id="exampleInputEnrolled"
                                            placeholder="Name" value="Yes" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputGrade">Grade :</label>
                                        <input type="email" class="form-control is-disabled" id="exampleInputGrade"
                                            placeholder="10" value="10" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputGraduate">Graduated :</label>
                                        <input type="email" class="form-control is-disabled" id="exampleInputGraduate"
                                            placeholder="No" value="" disabled>
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputID">Graduated :</label>
                                        <input type="email" class="form-control is-disabled" id="exampleInputID"
                                            placeholder="7889887" value="" disabled>
                                    </div>
                                    <div class="form-group">

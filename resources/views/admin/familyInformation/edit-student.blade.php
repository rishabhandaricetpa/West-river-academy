      ...
      <div class="card family-details px-3 mb-4">
          ...
          <div class="tab-content">
            ...
            <div class="row">
              <div class="col-12 d-flex align-items-center">
                <h2 class="pr-3"><a href="{{ route('admin.parent.edit', $parent_id) }}">{{ $student->fullname }}</a>
                </h2>
                  ...
                  <div class="row">
                    ...
                    <div class="col-12">
                      <div class="form-group lato-italic info-detail d-flex">
                        ...
                        <div class="form-check">
                          <input class="form-check-input mt-0" type="radio" name="student_gender" value="Female" id="gender">
                          <label class="form-check-label pl-1 pl-sm-0">
                            Female
                          </label>
                        </div>
        ...
        <nav class="student-detail_documents">
          <div class="nav nav-tabs justify-content-start" id="nav-tab" role="tablist">
            ...
            <a class="nav-link" id="studentGraduation-tab" data-toggle="tab" href="#studentGraduation" role="tab"
              aria-controls="studentGraduation" aria-selected="false">Graduation</a>
        ...
        <div class="tab-content" id="nav-tabContent">
                      ...
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th scope="col" class="text-right"><button type="button" class="btn btn-modal ml-3"
                              data-toggle="modal" data-target="#Student-activityModal"
                  ...
                  <div class="modal-body">
                    <form id="add-new-enrollments">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          <input type="hidden" value="{{ $student->id }}" id='student_name' name="student_name"
                            class="form-control">
                        </div>
                        <div class="form-group  col-md-6">
          ...
          {{-- Graduation --}}
          <div class="tab-pane fade" id="studentGraduation" role="tabpanel" aria-labelledby="studentGraduation-tab">
                      ...
                      <thead class="thead-light">
                        <tr>
                          ...
                          <th scope="col"><button type="button" class="btn btn-modal ml-3" data-toggle="modal"
                              data-target="#studentGraduationModal" data-whatever="@getbootstrap"><img
                                src="/images/add.png" alt=""><img src="/images.add.png" alt=""></button></th>
                        </tr>
                      </thead>
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><a href="{{ route('admin.edit.graduation', $graduation->id) }}">View
                          </td>
                          <td></td>
                        </tr>
                        @endforeach

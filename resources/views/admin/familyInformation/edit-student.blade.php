                            ...
                            <div class="row">
                                <div class="col-12 d-flex align-items-center">
                                    ...
                                    <div class="form-group mb-0">
                                        <select required class="btn btn-primary dropdown-toggle dropdown-icon"
                                            id="student_status">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="form-group lato-italic info-detail d-flex">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="radio" name="student_gender"
                                                        ...
                                                        <div class="form-group lato-italic info-detail">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-6">
                                                                    ...
                                                                    <div class="form-check">
                                                                        <input class="form-check-input" type="radio"
                                                                            id="grade_level[]" value="Kindergarten"
                                                                            required>
                                                                        <label class="form-check-label pl-1 pl-sm-0">
                                                                            Kindergarten
                                                                        </label>
                                            ...
                                            <form id="add-record-request">
                                                ...
                                                <div class="form-group">
                                                    <label for="message-text"
                                                        class="col-form-label">State/Province/Region</label>

                ...
                <form class="is-readonly row students_store" id="sampleForm">
                  ...
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control is-disabled" id="graduation" placeholder="No" value=""
                        disabled>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="overflow-auto max-table">
                    <table class="table table-striped table-styling w-100 table-vertical_scroll">
                      ...
                      <tbody>
                        <tr>
                          <td>notes</td>
                          <td>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Tempora rerum enim voluptates
                            vel necessitatibus possimus mollitia. Odio quam iusto aut voluptates beatae animi doloribus
                            illo officia recusandae quidem dolore, sunt in iste aspernatur, odit voluptas reprehenderit
                            blanditiis repudiandae quasi ullam obcaecati explicabo corrupti laborum! Error perferendis
                      ...
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <select id="transcript_name" required class="form-control">
                            <option value="enrollment" id="transcript_name">Enrollment</option>
                            <option value="transcript" id="transcript_name">Transcript</option>
                            <option value="postage" id="transcript_name">Postage</option>
                            <option value="apostille" id="transcript_name">Apostille</option>
                            <option value="notarization" id="transcript_name">Notarization</option>
                            <option value="transcript_consultation" id="transcript_name">Personal Consultation</option>
                            <option value="custom_payments" id="transcript_name">Custom Payments</option>
                            <option value="custom_letter" id="transcript_name">Custom Letter</option>
                            <option value="graduation" id="transcript_name">Graduation</option>
                          </select>
                        </div>
                        <div class="form-group col-md-6">
                          <label for="recipient-name" class="col-form-label">Amount:</label>
                    ...
                    <div class="modal-body">
                      <div class="row">
                        ...
                        <div class="form-group col-md-6">
                          ...
                          <input type="text" id="file" class="form-control choose-btn" required>
                        </div>
                      </div>
                    </div>
                    <div class="modal-footer">

          ...
          <div class="form-group w-100 row mx-0">
            ...
            <div class="col-md-4 mb-4 mb-sm-0">
              ...
              <select name="grade[]" class="form-control">
                ...
                <option class="form-control" value="10" @if ($enrollment_period->grade_level == '10')
                  selected="selected" @endif>10</option>

                <option class="form-control" value="11" @if ($enrollment_period->grade_level == '11')
                  selected="selected" @endif>11</option>

                <option class="form-control" value="12" @if ($enrollment_period->grade_level == '12')

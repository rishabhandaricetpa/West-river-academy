          ...
          <form class="is-readonly row" id="repForm">
            ...
            <div class="col-md-6">
              ...
              <div class="pt-3 d-md-flex">
                ...
                <button type="button" class="btn btn-default btn-primary form-enable btn-edit js-edit mr-2"
            ...
            <div class="col-md-6">
              <div class="bg-light p-3">
                <button type="button" class="btn btn-primary ml-2 mb-2" data-target="#testing1" data-toggle="modal"
                  ...
                  <thead class="thead-light">
                    <tr>
                      ...
                      <th scope="col"><button type="button" class="btn btn-modal ml-3" data-toggle="modal"
                          data-target="#repdetail-docModal" data-whatever="@getbootstrap"><img src="/images/add.png"

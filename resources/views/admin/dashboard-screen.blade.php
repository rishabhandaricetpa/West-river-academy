                        ...
                        <div class="card-header">
                            @if ($isAdmin)
                                <button class="btn btn-primary mr-auto" type="submit"
                                    onclick="sendArchieve()">Archive</button>
                            @endif
                        </div>
                                        ...
                                        <tr>
                                            @if ($isAdmin)
                                                <td> <input type="checkbox" value="{{ $data->id }}" name="is_archived"
                                                        onclick="archieve(this.value)"> </td>
                                            @endif
                                            ...
                                            @elseif($data->related_to === 'custom_record_received')
                                                <td><a href="{{ route('edit.custompayment', $data->linked_to) }}">Custom
                                                        Payment</a></td>
                                            ...
                                            @if (!$isAdmin)
                                                <td><a href="javascript:void(0)" data-id="{{ $data->id }}"
                                                        ...
                                                        data-target="#assignStatusToRecord"

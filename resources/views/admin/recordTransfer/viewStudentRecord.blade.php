                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form method="post"
                                        action="{{ route('admin.sendRecordToSchool', $studentRecord->student_profile_id) }}">
                                        @csrf
                                        <input type="hidden" value="{{ $studentRecord->id }}" name="record_id">
                                        <input type="hidden" value="{{ $studentRecord->status }}" name="status">
                                        <input type="hidden" value="{{ $studentRecord['student']['fullname'] }}"
                                            name="student_name" id="record_student_name">
                                        <input type="hidden" name="last_grade_in"
                                            value=" {{ $studentRecord->last_grade }}">

                                        <div class="form-group">
                                            <label for="recipient-name" class="col-form-label">To:</label>
                                            <input type="text" class="form-control" id="recipient-name"
                                                value='{{ $studentRecord->email }}' name="school_email" type="email">
                                        </div>

            ...
            <div class="form-wrap border py-5 px-25 position-relative generate-Coupon">
                    ...
                    <div class="col-sm-6 form-group">
                        ...
                        <div class="d-sm-flex w-100">
                            ...
                            <button type="button" id="generate-code"
                                class="btn btn-secondary text-uppercase mt-3 mt-sm-0 ml-sm-3"> Generate Code</button>
                        </div>
                    </div>
                    <div class="col-sm-6 form-group">
                        <label for="amount">Amount <small>(required)</small>:</label>
                        <input type="number" class="form-control" min="0" required id="amount" name="amount"
              ...
              <input type="number" class="form-control" min="0" id="redeem" name="redeem_left" placeholder="limit the times coupon can be used">
                    ...
                    <div class="form-group col-sm-12">
                        ...
                        <select name="assign[]" class="form-control select2-multiple mb-3" multiple="multiple"
                            id="assign-select">

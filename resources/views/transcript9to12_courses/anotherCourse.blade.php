...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            <h3> Select a Elective course:</h3>
            <another-transcript-course :trans_id='@json($trans_id)' :total_credits='@json($total_credits)' :all_credits='@json($all_credits)' :anothersubjects='@json($anotherSubjects)' :transcript_id='@json($transcript_id)' :courses_id='@json($courses_id)' :student_id='@json($student_id)'></another-transcript-course>
        </div>

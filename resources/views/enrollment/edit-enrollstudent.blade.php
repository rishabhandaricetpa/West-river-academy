    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-body">
                <p>Annual enrollment covers the 12 months from {{Carbon\Carbon::parse($countryData->start_date)->format('F j')}} - {{Carbon\Carbon::parse($countryData->end_date)->format('F j')}}.
                    Second Semester Only covers {{Carbon\Carbon::parse($semestermonth)->format('F j')}} - {{Carbon\Carbon::parse($countryData->end_date)->format('F j')}}.

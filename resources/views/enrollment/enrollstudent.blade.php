    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-body">
                <p>Annual enrollment covers the 12 months from {{Carbon\Carbon::parse($start_date)->format('F j')}} - {{Carbon\Carbon::parse($end_date)->format('F j')}}. Second Semester Only covers {{Carbon\Carbon::parse($semestermonth)->format('F j')}} - {{Carbon\Carbon::parse($end_date)->format('F j')}}. If you prefer to start your enrollment on the date you enroll, select that date. If you want your
                    enrollment to date back to {{Carbon\Carbon::parse($start_date)->format('F j')}}, even though it is now later in the year, you can do so.</p>

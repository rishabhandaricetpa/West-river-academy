...
<main class="position-relative container form-content mt-4">
    ...
    <div class="form-wrap border bg-light py-2r px-25 text-center dashboard-info">
        <p>You are ready to select the courses and grades to put on the transcript for <a href="#">{{$enroll_student->fullname}}</a></p>
        ...
        <a href="{{route('display.studentProfile',[$enroll_student->id,$transcriptData])}}" class="btn btn-primary mt-4 font-weight-bold">Start to create transcript</a>
    </div>
</main>

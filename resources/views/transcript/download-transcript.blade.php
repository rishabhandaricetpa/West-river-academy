...
@section('content')
    ...
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-2r px-25 text-center dashboard-info">
            ...
            <p><embed src="{{ $data->transcript_file }}" width="400px" height="200px" /></p>

            <a href="{{ $data->transcript_file }}" class="btn btn-primary mt-4 font-weight-bold">Download</a>
        </div>
    </main>
    <!-- Modal -->
    <div class="modal fade" id="transcript-notification" tabindex="-1" aria-labelledby="chooseDatesLabel"
        aria-hidden="true">

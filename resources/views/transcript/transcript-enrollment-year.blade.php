        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            <form method="post" class="mb-0" action="{{ route('update.enrollYear', [$id, $transcript->id]) }}">
                ...
                <div class="form-group mb-2 lato-italic info-detail pb-4">
                    ...
                    <h3 class="mb-3">Select the year for this grade. It must be a year that you were either enrolled in West
                        River Academy or you have provided a transcript from another school.</h3>
                    ...
                    @endforeach
                    {{-- <div class="d-md-flex mt-3">Choose Other Year <input type="number" class="ml-md-2 form-control col-md-3" name="other_year"></div> --}}
                </div>

...
<main class="position-relative container form-content mt-4 label-styling label-md">
  ...
  <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
    <form method="post" class="mb-0" action="{{route('transcript.enrollment_year',$id,$transcript->id)}}">
      @csrf
      <div class="form-group mb-2 lato-italic info-detail pb-4">
        ...
        <div class="form-check mb-2">
          <input class="form-check-input" type="radio" value="{{$year}}-{{$year+1}}" name="enrollment_year" required>

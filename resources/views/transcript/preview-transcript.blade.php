    ...
    <div class="modal-content">
      <div class="modal-body">
            ...
            <tr style="width:100%;">
              ...
              <td width="30%" style="text-align:right;">
                <table width="100%">
                  <tbody>
                    <tr style="width:100%;">
                      <td style="white-space: pre;font-weight:600;text-transform:uppercase;padding-left:22px;"><span style="border-bottom:1px solid #000;display:inline-block;font-size:11px;">GRADING SYSTEM</span></td>
                    </tr>
                    <tr style="width:100%;">
        ...
        <table width="100%">
          <tbody>
            <tr>
              <td width="50%" style="text-align:center;position: relative;"> <a type="submit" href="{{ route('another.grade',$student->id) }}" style="background-color: #FC0;line-height:1;color: #000;border: 0;border-radius: 5px;padding: 10px 16px;font-size: 14px;display:inline-block; position: absolute; left:45%;top:10px;">Edit</button></td>

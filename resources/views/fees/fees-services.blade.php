        ...
        <div class="form-wrap border bg-light py-5 px-25 mb-4 service-list">
                ...
                <div class="row">
                    <div class="col-11 col-sm-3">
                        <div class="bg-secondary h-100 d-flex align-items-center justify-content-center">
                            ...
                            <h2 class="text-white mb-0 text-center pl-3">Renew my Family’s Enrollment<span
                                    class="d-block">(for future or past years)</span></h2>
                        </div>
                    </div>
                    <div class="col-sm-9 d-sm-flex">
                        <div class="row">
                            ...
                            <div class="col-3 text-right">
                                <p class="text-secondary lato ">
                                    <strong>${{ getFeeDetails('first_student_annual') }}</strong> </p>
                                <p class="text-secondary lato ">
                                    <strong>${{ getFeeDetails('first_student_half') }}</strong></p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 d-sm-flex">
                        <div class="row">
                            ...
                            <div class="col-3 text-right">
                                <p class="text-secondary lato ">
                                    <strong>${{ getFeeDetails('additional_student_annual') }}</strong> </p>
                                <p class="text-secondary lato ">
                                    <strong>${{ getFeeDetails('additional_student_annual') }}</strong></p>
                            </div>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9 d-sm-flex">
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="max-width__275">Per student fee covers Graduation Project and high school transcript
                            </p>
            ...
            <div class="bg-white">
                <div class="row">
                    ...
                    <div class="col-sm-9 d-sm-flex">
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="max-width__275">First class postage is free. Express Mail postge is added to documents
                                that have been Notarized or sent for Apostilles. Other expedited postage fees are listed. We
                                are not responsilble for lost items.</p>
                        </div>
                        <div class="text-center">
                            ...
                            <table width="100%">
                                <tr>
                                    ...
                                    <td class="text-secondary text-right">${{ getFeeDetails('express_international') }}
                                    </td>
                                </tr>
                                <tr>
                                    <th>Express Mail Tier 2 (for Hungary, Philippines, Romania, South Africa, Spain)</th>
                                    <td class="text-secondary text-right">
                                        ${{ getFeeDetails('global_guaranteed_international') }}</td>
                                </tr>
                                <tr>
                                    <th>Express Mail Tier 3 (for Argentina and Brazil)</th>
                                    <td class="text-secondary text-right">${{ getFeeDetails('priority_international') }}
                                    </td>
                                </tr>
                            </table>

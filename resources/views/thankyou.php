...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Catamaran:wght@100;200;300;400;500;600;700;800;900&family=Judson:ital,wght@0,400;0,700;1,400&display=swap" rel="stylesheet">
...
<header class="site-header">
  ...
  <main class="position-relative container form-content mt-4">
    <div class="form-wrap border bg-light form-content small-container">
      ...
      <p class="mb-0">Enter the information below and click “Submit.” An email with a link to activate your account will be sent to the email address you provide. You will then be able to sign in, enroll and purchase other services.</p>
  </div>
</main>

@extends('layouts.app')
@section('pageTitle', 'Social Science Language Course')
@section('content')
...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            ...
            <edit-history-transcript-course :outofcredit='@json($outOfCredit)' :sciencecourse='@json($socialScienceCourse)' :transcripts='@json($transcripts)' :student_id='@json($student_id)' :courses_id='@json($courses_id)' :transcript_id='@json($transcript9_12id)' :total_credits='@json($credits)'>
            </edit-history-transcript-course>
        </div>
    </main>

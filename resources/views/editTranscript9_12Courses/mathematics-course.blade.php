...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            ...
            <edit-mathematics-transcript-course :outofcredit='@json($outOfCredit)' :mathscourse='@json($mathsCourse)' :transcripts='@json($transcripts)' :student_id='@json($student_id)' :courses_id='@json($courses_id)' :transcript_id='@json($transcript9_12id)' :total_credits='@json($credits)'>

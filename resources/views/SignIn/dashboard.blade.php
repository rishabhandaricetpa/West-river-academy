...
<<<<<<< HEAD
        ...
        <div class="col-sm-12">
            <p>Need help? Check out our <a href="{{route('video.tutorials')}}">Dashboard Tutorial </a> <span class="px-4">or</span><a href="#" role="button" class="btn btn-primary"> Help me Decide</a></p>
        </div>
    </div>
    </div>
...
>>>>>>> d23f362069ab4906468ef191b57748f91f4abe2a
        </div>
        @if (count($transcript) > 0)
            <div class="form-wrap border bg-light py-5 px-25 mb-4">
                <h2 class="mb-3">Transcripts</h2>

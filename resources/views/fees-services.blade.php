                  ...
                  <div class="text-center">
                   ...
                   <h3 style="text-transform: uppercase;">International :</h3>
                    <table width="100%">
                       <tr>
                         <th>Express</th>
                         <td class="text-secondary text-right">$55</td>
                       </tr>
                       <tr>
                         <th>Global Guaranteed</th>
                         <td class="text-secondary text-right">$85</td>
                       </tr>
                       <tr>
                         <th>Priority</th>
                         <td class="text-secondary text-right">$45</td>
                       </tr>
                     </table>
                     ...
                     <table width="100%">
                       <tr>
                         <th>Priority</th>
                         <td class="text-secondary text-right">$10</td>
                       </tr>
                       <tr>
                         <th>Express</th>
                         <td class="text-secondary text-right">$30</td>
                       </tr>
                     </table>
                  </div>
              </div>

...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            <h3>Select an Another course:</h3>
            <edit-another :anothercourse='@json($another_course)' :transcripts='@json($transcripts)' :student_id='@json($student_id)' :courses_id='@json($courses_id)' :transcript_id='@json($transcript_id)'> </edit-another>
        </div>
    </main>

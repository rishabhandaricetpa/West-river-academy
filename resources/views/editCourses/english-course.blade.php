...
<div id="app">
    <main class="position-relative container form-content mt-4">
        ...
        <div class="form-wrap border bg-light py-5 px-25 dashboard-info">
            ...
            <edit-english-course :englishcourse='@json($englishCourse)' :transcripts='@json($transcripts)' :student_id='@json($student_id)' :transcript_id='@json($transcript_id)'> </edit-english-course>
        </div>
    </main>

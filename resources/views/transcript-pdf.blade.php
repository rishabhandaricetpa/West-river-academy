        ...
        <div style="display:flex;flex-wrap:wrap;align-items: center;">
            ...
            <div style="width:50%;display:flex;">
                <div style="margin-left:auto;text-align:center;">
                    <img src="https://www.westriveracademy.com/cwp/img/wra_logo.svg" alt="logo"
                        style="filter: brightness(0.5);max-width: 300px;margin: 0 auto;object-fit:contain;">
            ...
            <div style="width:50%;display:flex;">
                <ul style="list-style-type:none;padding-left:0;margin-left:auto;">
                    <li style="display:flex;">Date of birth <span>october 19, 2010</span></li>
            ...
            <table style="width:60%;border:2px solid #000;border-collapse:collapse;text-transform:uppercase;">
                <thead>
                    <tr>
                        <th colspan="2" style="border-bottom:1px solid #000;font-size: 14px;font-weight:400;">course
                            name</th>
                        <th
                            style="border-bottom:1px solid #000;border-left:1px solid #000;font-size: 14px;font-weight:400;">
                            Grade 4</th>
                        <th
                            style="border-bottom:1px solid #000;border-left:1px solid #000;font-size: 14px;font-weight:400;">
                            Grade 5</th>
                ...
                <tbody>
                    <tr>
                        <td colspan="2" style="border-bottom:1px solid #000;font-size: 14px;">mathematics</td>
                        <td style="border-bottom:1px solid #000;border-left:1px solid #000;font-size: 14px;">grade 4
                        </td>
                        <td style="border-bottom:1px solid #000;border-left:1px solid #000;font-size: 14px;">grade 5
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2" style="border-bottom:1px solid #000;font-size: 14px;">mathematics</td>
                    ...
                    <tr>
                        <td colspan="2" style="font-size: 14px;">mathematics</td>
                        <td style="border-left:1px solid #000;font-size: 14px;">grade 4</td>
                        <td style="border-left:1px solid #000;font-size: 14px;">grade 5</td>
                    </tr>
                </tbody>
            </table>
            ...
            <div style="width:100%;display:flex;flex-wrap:wrap;align-items:center;">
                <div style="width:60%;display:flex;flex-wrap:wrap;">
                    <div
                        style="width:60%;text-transform:uppercase;text-align:center;padding:15px;box-sizing:border-box;">
                        <span style="border-top: 1px solid #000;display:block;">official signature</span></div>
                    <div
                        style="width:40%;text-transform:uppercase;text-align:center;padding:15px;box-sizing:border-box;">
                        <span style="border-top: 1px solid #000;display:block;">date</span></div>
                </div>
                <div style="width:40%;">
            ...
            <div style="display: flex;justify-content: space-around;width: 100%;">
                <button type="submit"
                    style="background-color: #FC0;color: #000;border: 0;border-radius: 5px;padding: 10px 16px;font-size: 14px;">Edit</button>
                <button type="submit"
                    style="background-color: #FC0;color: #000;border: 0;border-radius: 5px;padding: 10px 16px;font-size: 14px;">Submit</button>
            </div>
        </div>
        <div>

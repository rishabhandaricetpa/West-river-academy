...
class ImportCustomLetter extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Import Custom Letter  data';
    ...
    public function handle()
    {
        ...
        $filePath = base_path('csv/CustomLetterPayment.csv');
        ...
        foreach ($reader->getSheetIterator() as $sheet) {
            foreach ($sheet->getRowIterator() as
                ...
                if ($legacy_name) {
                    $notarization_data =  CustomLetterPayment::create([

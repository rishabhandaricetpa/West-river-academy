...
class ForeignCourse extends Controller
{
    public function index($student_id, $transcript_id)
    {
        ...
        return view('transcript9to12_courses.foreignCourse', compact('courses_id', 'foreignSubjects', 'student_id', 'transcript_id', 'all_credits', 'total_credits', 'selectedCreditRequired'));
    }
